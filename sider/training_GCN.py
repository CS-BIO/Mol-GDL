...
data_train = TestbedDataset(root='data', dataset='sider_train')
data_valid = TestbedDataset(root='data', dataset='sider_validation')
data_test = TestbedDataset(root='data', dataset='sider_test')
