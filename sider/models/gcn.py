...
class GCNNet(torch.nn.Module):
    def __init__(self, num_features_xd=62, n_output=27, num_features_xt=954, output_dim=64, dropout=0.2, num_net=5, file=None):
        ...
        # combined layers
        self.fc1 = nn.Linear(output_dim*num_net, 128)
