...
data_train = TestbedDataset(root='data', dataset='Lipophilicity_train')
data_valid = TestbedDataset(root='data', dataset='Lipophilicity_validation')
data_test = TestbedDataset(root='data', dataset='Lipophilicity_test')
