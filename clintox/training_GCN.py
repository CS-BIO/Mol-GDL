...
data_train = TestbedDataset(root='data', dataset='clintox_train')
data_valid = TestbedDataset(root='data', dataset='clintox_validation')
data_test = TestbedDataset(root='data', dataset='clintox_test')
